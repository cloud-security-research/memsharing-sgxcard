...
static int vcablk_bcknd_max_dev = 256;
module_param(vcablk_bcknd_max_dev, int, S_IRUGO);
MODULE_PARM_DESC(vcablk_bcknd_loop, "Maximum number of vca block devices");
